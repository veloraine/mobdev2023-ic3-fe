...
abstract class $PokemonCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String type, int height, int weight});
}
...
class _$_Pokemon implements _Pokemon {
  ...
  @override
  String toString() {
    return 'Pokemon(name: $name, type: $type, height: $height, weight: $weight)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, type, height, weight);
